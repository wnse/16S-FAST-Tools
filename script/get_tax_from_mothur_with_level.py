...
if __name__ == '__main__':
    ...
    parser.add_argument('-taxfile', '--taxfile',
                        help='mothur wang.taxonomy file',
                        required=True)
    parser.add_argument('-table', '--table',
                        help='asv/otu table',
                        required=True)
    parser.add_argument('-taxfile_reads', '--taxfile_reads',
                        help='output excel file for reads.',
                        default='tax_reads.xlsx')
    parser.add_argument('-taxfile_ratio', '--taxfile_ratio',
                        help='output excel file for ratio.',
                        default='tax_ratio.xlsx')
    args = parser.parse_args()
    get_tax_from_mothur_with_level(args.taxfile,
                                   args.table,
                                   args.taxfile_ratio,
                                   args.taxfile_reads)
