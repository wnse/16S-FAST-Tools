...
if __name__ == '__main__':
    ...
    parser.add_argument('-data_col','--col_of_data_path',help='columns of data path (a1,a2,l1,l2). defalut=2,4,6,8',default='2,4,6,8')
    parser.add_argument('-name_col','--col_of_name',help='columns of sample name. defalut=1',default=1)
    ...
    submit_16S_FAST_group_from_list(df,colums,remark,name)
