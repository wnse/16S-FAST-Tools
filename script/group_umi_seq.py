...
if __name__ == '__main__':
    ...
    parse.add_argument('-t', '--threads', help='cpu threads', default=1, type=int)
    ...
    umi_counts, umi_id_counts, umi2seq = queu_group_umi_seq(args.fastq,
                                                            umi2ID,
                                                            args.outdir,
                                                            aUMI,
                                                            args.threads)
    df_umi_info = pd.merge(df_umi_info,
